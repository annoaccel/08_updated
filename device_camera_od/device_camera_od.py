...
# st.header("Welcome To Device Camera with OD")
...
# # threshold22 = st.slider("Threshold1", min_value=0, max_value=1000, step=1, value=100)
...
def device_main():
    st.image('./logo.png')
    st.header("Avistos Innovative Solutions")
